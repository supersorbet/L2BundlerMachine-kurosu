...
1. **L1DepositorV2\_** - Handles deposits and yield withdrawals on Ethereum Mainnet
2. **BundledYieldVaultV2\_** - Manages yield strategies and harvesting on Ink L2
...
* [Security Architecture](broken-reference) - Access control and security mechanisms

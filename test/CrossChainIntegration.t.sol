...
import {MockTydroPool, MockAToken} from "./mocks/MockTydroPool.sol";
import {MockAcrossBridge, MockRelayDepository} from "./mocks/MockBridge.sol";

/// @title CrossChainIntegrationTest
/// @notice Integration tests simulating real cross-chain yield operations
contract CrossChainIntegrationTest is Test {
    ...
    function setUp() public {
        ...
        vm.prank(treasury);
        l2Vault.setTokenMapping(address(usdt0L2), address(usdtL1));
    ...
    function testFullCrossChainFlow() public {
        ...
        usdt0L2.mint(address(l2Vault), depositAmount);
    ...
    function testAutoGasRefill() public {
        ...
        // Enable auto-refill
        l2Vault.setAutoGasRefill(50); // 0.5%
        ...
        // Note: In real scenario, ETH would come from somewhere
